            ...
            <div className="flex flex-wrap items-center justify-center gap-4 md:gap-16 max-lg:mt-10">
              <div className="flex justify-between items-center">
                <div className="flex justify-between md:space-x-10 max-md:flex-col">
                  {/* Wrap first HoverCard with motion.div for hover scale effect */}
                    ...
                    <HoverCard backgroundColor="#a55eea" direction="flex-col" left="-400px">
                      <div className="md:flex flex-col flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-40 items-center text-center">
                        ...
                        <p className="mb-4 md:text-xl text-[16px] text-[#7d8590] px-4 mx-auto">
                          Whether you're scaling your startup or just learning how to code, GitHub is your home. Join the world's largest
                          developer platform to build the innovations that empower humanity. Let's&nbsp;build from&nbsp;here.
                        </p>
                  ...
                  {/* Wrap second HoverCard with motion.div for hover scale effect */}
                  <motion.div whileHover={{ scale: 1.05 }} transition={{ duration: 0.3 }}>
