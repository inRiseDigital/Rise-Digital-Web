...
// Dynamically import HoverCard with SSR disabled to prevent hydration errors
                    ...
                    <div className='md:w-10/12 mb-24'>
                        ...
                        >
                            <h3
                                ...
                                style={{ transitionDelay: '300ms' }}
                            >
                                <p className={`text-[#939aff] ${heading1.className}`}>We Build Thinkers, Not Just Tools</p>
                                <span className={`text-[28px] md:text-[32px] leading-[36px] font-heading3 ${heading2.className}`}>
                                    From digital minds that manage customer experiences to infrastructure that scales without a whisper—we build tools that think and tech that feels alive.
                                </span>
                            </h3>
                        </motion.h3>
                    </div>
